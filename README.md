...
Angular Signals and RxResources
State Management
REST APIs
Reactive Forms
Client-side Caching
...
Reactive forms
API communication
Administrative dashboard foundations
Responsive UI
Planned
...
Render
Netlify
A production-oriented Angular e-commerce application focused on scalability, maintainability, authentication, and modern frontend development practices.
